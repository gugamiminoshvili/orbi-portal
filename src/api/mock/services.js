// Per-apartment services mock data — lifted from
// reference/orbi-portal-redesign.html (lines 879-905), with every balance
// SIGN-FLIPPED on 2026-08-06: the reference authored debts as negative, and
// the owner's ruling is that a positive balance is what the resident owes
// (utils/balance.js). A5 keeps a negative maintenance balance on purpose, so
// at least one apartment in the demo shows the advance case in green.
...
export const SERVICES = {
  ...
  A5: { maintenance: { balance: -40, tariff: 90, start: '17 Jul 2024' }, water: { counter: 'W-1702-01', indication: '00150 m³', updated: '5 Jun 2026' }, electricity: { counter: 'E-1702-01', status: 'Active', balance: 0, updated: '5 Jun 2026' }, internet: { provider: 'Silknet', plan: 'Fiber 100 Mbps', balance: 0, status: 'Active', updated: '1 Jun 2026' } },
}
